...
def get_args():
    ...
    parser.add_argument('--video_features_directory', type=str,
                        default='/Users/ozge/PycharmProjects/crosstask_data/features')
    ...
    parser.add_argument('--crosstask_annotation_path', type=str,
