"""This module is taken from: https://github.com/antoine77340/MIL-NCE_HowTo100M"""
...
class S3D(nn.Module):
    ...
    def __init__(self, num_classes=512, gating=True, space_to_depth=False,
                  word2vec_path='data/word2vec.pth', init='uniform', token_to_word_path='data/dict.npy'):
